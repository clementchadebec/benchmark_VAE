...
from pythae.trainers import AdversarialTrainer, AdversarialTrainerConfig, BaseTrainerConfig, BaseTrainer
...
def main(args):
    ...
    trainer = AdversarialTrainer(
        ...
        autoencoder_scheduler=None,#ae_scheduler,
        discriminator_scheduler=None,#dis_scheduler,
        callbacks=callbacks,
    )
