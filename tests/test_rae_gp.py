...
class Test_Model_Saving:
    def test_default_model_saving(self, tmpdir, model_configs):
        ...
        # reload model
        model_rec = RAE_GP.load_from_folder(dir_path)
...
class Test_RAE_GP_Training:
    ...
    def test_checkpoint_saving(
        ...
        model_rec = RAE_GP.load_from_folder(os.path.join(checkpoint_dir))
    ...
    def test_final_model_saving(
        ...
        # check reload full model
        model_rec = RAE_GP.load_from_folder(os.path.join(final_dir))
