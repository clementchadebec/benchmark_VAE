...
def dummy_handler(init_callback):
    return CallbackHandler(callbacks=[init_callback], model=None, optimizer=None, scheduler=None)
...
class Test_TrainerCallbacks():
    ...
    def test_init_trainer(self, ae, train_dataset, callbacks):
        ...
        assert ProgressBarCallback().__class__ in [cb.__class__ for cb in trainer.callback_handler.callbacks]
