...
class Test_Model_Saving:
    def test_default_model_saving(self, tmpdir, model_configs):
        ...
        # reload model
        model_rec = AE.load_from_folder(dir_path)
...
class Test_AE_Training:
    ...
    def test_checkpoint_saving(
        ...
        model_rec = AE.load_from_folder(os.path.join(checkpoint_dir))
    ...
    def test_checkpoint_saving_during_training(
        ...
        training_dir = os.path.join(dir_path, f"AE_training_{trainer._training_signature}")
    ...
    def test_final_model_saving(
        ...
        # check reload full model
        model_rec = AE.load_from_folder(os.path.join(final_dir))
    ...
    def test_ae_training_pipeline(
        ...
        training_dir = os.path.join(dir_path, f"AE_training_{pipeline.trainer._training_signature}")
        assert os.path.isdir(training_dir)
