...
@pytest.fixture(params=[
    VAEConfig(input_dim=784, latent_dim=10, reconstruction_loss='bce'),
    VAEConfig(input_dim=100, latent_dim=5)])
...
class Test_VAE_Training:
    ...
    def test_checkpoint_saving(
        ...
        model_rec = VAE.load_from_folder(os.path.join(checkpoint_dir))
