...
Several samplers are available for each models please check [here](https://github.com/clementchadebec/benchmark_VAE#available-models) to see which ones apply to your vae.
