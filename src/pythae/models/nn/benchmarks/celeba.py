...
class Encoder_VAE_CELEBA(BaseEncoder):
    ...
    def __init__(self, args: BaseAEConfig):
        ...
        self.embedding = nn.Linear(1024 * 1 * 4, args.latent_dim)
        self.log_var = nn.Linear(1024 * 1 * 4, args.latent_dim)
...
class Encoder_GMVAE_CELEBA(BaseEncoder):
    def __init__(self, args: dict):
        ...
        self.embedding_z = nn.Linear(1024, self.gmm_latent_dim)
        self.log_var_z = nn.Linear(1024, self.gmm_latent_dim)

        self.embedding_w = nn.Linear(1024, self.latent_dim)
        self.log_var_w = nn.Linear(1024, self.latent_dim)
